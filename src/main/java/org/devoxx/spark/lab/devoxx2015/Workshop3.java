...
public class Workshop3 {
    ...
    public static void main(String... args) {
        ...
        System.out.println("products.first : " + products.first());
        ...
        System.out.println("frame.first : " + frame.first());

        DataFrame frame2 = sqlContext.sql("SELECT * FROM products order by 1");
        System.out.println("COUNT : " + frame2.count());
        frame2.show(new Long(frame2.count()).intValue());
